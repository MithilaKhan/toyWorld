...
const Banner = () => {
   return (
      ...
      <h1 className='   font-bold text-rose-500 pt-6 '>Beautiful </h1>
      <p className=' text-yellow-500    font-bold'>Disney Princess</p>
      <p className= "font-bold  text-rose-600">Dolls</p> 
      </div>
