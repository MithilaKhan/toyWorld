...
const Gallery = () => {
   ...
   return (
      <div className=' w-3/4  mx-auto'>
         ...
         {/* img 1 */}
         <div className="card card-compact h-80  w-full bg-base-100 shadow-xl" data-aos="zoom-in-up">
  ...
  <div className="card-body">
    <h2 className="card-title">Cinderella</h2>
         ...
         {/* img 3 */}
         <div className="card card-compact h-80  w-full bg-base-100 shadow-xl" data-aos="zoom-in-down">
